...
Compares Baseline, Knowledge-only, and Hybrid models
"""
import argparse
import json
import os
...
def main():
    ...
    parser.add_argument('--knowledge_only_checkpoint', type=str, required=True,
                       help='Path to knowledge-only model checkpoint')
